...
from ..adapters.git import artifacts as artifact_versioning
from ..adapters.git import project as project_git
from ..domain.approvals import parse_decision_blocks
from ..domain.roles import AgentsConfig, ModelsConfig
from ..domain.context.builder import BuildRequest, ContextBuilder
from ..domain.context.denylist import ContextPolicy
from ..adapters.context.providers import (
...
from ..domain.context.tokens import TokenEstimator
from ..adapters.storage.events import EventLog, EventType
from ..domain.sessions import Session, SessionManager, SessionPolicy
...
class TurnRunner:
    ...
    def _current_index_revision(self, role_cfg) -> str | None:
        ...
        from ..adapters.indexing.freshness import ensure_fresh
